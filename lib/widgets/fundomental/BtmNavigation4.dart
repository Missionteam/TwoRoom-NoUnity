...
class ScaffoldWithNavBar4 extends ConsumerStatefulWidget {
  /// Constructs an [ScaffoldWithNavBar4].
  const ScaffoldWithNavBar4({
    required this.child,
    Key? key,
  }) : super(key: key);
  ...
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _ScaffoldWithNavBar3State();

  static int _calculateSelectedIndex(BuildContext context) {
    final String location = GoRouterState.of(context).location;
    if (location.startsWith('/Home1/Chat1')) {
      return 1;
    }
...
class _ScaffoldWithNavBar3State extends ConsumerState<ScaffoldWithNavBar4> {
  @override
            ...
            child: ClipRRect(
              ...
              child: Container(
                ...
                child: BottomNavigationBar(
                  ...
                  currentIndex:
                      ScaffoldWithNavBar4._calculateSelectedIndex(context),
                  backgroundColor: backgroundColor,
                  elevation: 10,
  ...
  void _onItemTapped(int index, BuildContext context) {
    switch (index) {
      case 1:
        GoRouter.of(context).go('/Home1/Chat1');
        break;
      case 5:
