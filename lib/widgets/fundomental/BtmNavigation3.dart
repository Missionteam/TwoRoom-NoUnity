...
class ScaffoldWithNavBar3 extends ConsumerStatefulWidget {
  /// Constructs an [ScaffoldWithNavBar3].
  const ScaffoldWithNavBar3({
    required this.child,
    Key? key,
  }) : super(key: key);
...
class _ScaffoldWithNavBar3State extends ConsumerState<ScaffoldWithNavBar3> {
  @override
            ...
            child: ClipRRect(
              ...
              child: Container(
                ...
                child: BottomNavigationBar(
                  ...
                  currentIndex:
                      ScaffoldWithNavBar3._calculateSelectedIndex(context),
                  backgroundColor: backgroundColor,
                  elevation: 10,
